...
<h3 class="page-title"> Listado de Cortes
...
<div class="row" >
    ...
    <div class="form-group col-md-1">
        <a class="btn sbold orange" href="{{url('cortes/create')}}"> Nuevo
	    ...
	    <div class="portlet box oranget">
	        <div class="portlet-title">
	            <div class="caption colorwhite">
	                <i class="fa fa-user colorwhite"></i>Listado de Cortes </div>
	        </div>
	                ...
	                <table class="table table-hover">
	                    ...
	                    <tbody>
	                        ...
	                        <tr >
	                            ...
	                            <td style="vertical-align: middle;">  {{$item->id_med}} </td>
	                            ...
	                            <td style="vertical-align: middle;">       
                                        ...
                                        @include('cortes.modal-estado')
                                        @include('cortes.modal-delete')
                                </td>
	                        </tr>
	                        @endforeach
	                    </tbody>
